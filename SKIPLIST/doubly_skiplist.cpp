...
int main(int argc, char** argv){
    ...
    DoublySkipList* mySkipList = new DoublySkipList(14);
    ...
    my_result_file.open("doubly_output.csv");
    ...
    //cout << "Duration of Doubly SkipList solution in ms is: " << duration_in_ms << endl; 
